      ...
      <UserContext.Provider value={{ user, setUser }}>
        ...
        >
          ...
          <Routes>
            <Route
              path="/"
              element={<Home user={user} currSong={currSong} />}
              exact
            />
            ...
            <Route
              exact
              path="/premium"
              element={<Premium user={user} currSong={currSong} />}
            />

            <Route
              exact
              path="/premium/detector"
              element={<Detector user={user} currSong={currSong} />}
            />
            ...
            <Route
              path="/likedSongs"
              element={<LikedSongs user={user} currSong={currSong} />}
            />
